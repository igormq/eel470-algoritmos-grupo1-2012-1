...
${OBJECTDIR}/my_string.o: my_string.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/my_string.o my_string.cpp
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/tests/mystringtest_class.o ${TESTDIR}/tests/mystringtest_runner.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS} -lcppunit 


${TESTDIR}/tests/mystringtest_class.o: tests/mystringtest_class.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/mystringtest_class.o tests/mystringtest_class.cpp


${TESTDIR}/tests/mystringtest_runner.o: tests/mystringtest_runner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/mystringtest_runner.o tests/mystringtest_runner.cpp


${OBJECTDIR}/my_string_nomain.o: ${OBJECTDIR}/my_string.o my_string.cpp 
	${MKDIR} -p ${OBJECTDIR}
	@NMOUTPUT=`${NM} ${OBJECTDIR}/my_string.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/my_string_nomain.o my_string.cpp;\
	else  \
	    ${CP} ${OBJECTDIR}/my_string.o ${OBJECTDIR}/my_string_nomain.o;\
	fi
...
${OBJECTDIR}/StringCounter_nomain.o: ${OBJECTDIR}/StringCounter.o StringCounter.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/StringCounter_nomain.o StringCounter.cpp;\
	else  \
