...
${OBJECTDIR}/my_string.o: my_string.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/my_string.o my_string.cpp
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/statistics: ${TESTDIR}/tests/mystringtest_class.o ${TESTDIR}/tests/mystringtest_runner.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
...
${TESTDIR}/tests/mystringtest_class.o: tests/mystringtest_class.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${TESTDIR}/tests/mystringtest_class.o tests/mystringtest_class.cpp


${TESTDIR}/tests/mystringtest_runner.o: tests/mystringtest_runner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${TESTDIR}/tests/mystringtest_runner.o tests/mystringtest_runner.cpp
...
${OBJECTDIR}/my_string_nomain.o: ${OBJECTDIR}/my_string.o my_string.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/my_string_nomain.o my_string.cpp;\
	else  \
